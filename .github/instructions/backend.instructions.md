...
- Generate Prisma client: `DATABASE_URL=file:./prisma/dev.db npx prisma generate --workspace=backend`
- Seed database: `DATABASE_URL=file:./prisma/dev.db npm run db:seed --workspace=backend`
