...
async function main() {
  ...
  const suvRefuelings = [
    ...
    },
    {
      ...
      pricePerLiter: 1.58,
      mileage: 12400,
      station: "Cepsa Gran Vía",
    },
    {
      date: daysFromNow(-322),
      liters: 50.1,
      pricePerLiter: 1.65,
      mileage: 12900,
      station: "BP Alcobendas",
    },
    {
      ...
      pricePerLiter: 1.7,
      mileage: 13350,
      station: "Shell M-40 Sur",
    },
    {
      date: daysFromNow(-278),
      liters: 47.3,
      pricePerLiter: 1.55,
      mileage: 13800,
      station: "Repsol A-6 km 12",
  ...
  const cityRefuelings = [
    {
      ...
      pricePerLiter: 1.6,
      mileage: 5200,
      station: "Repsol Centro",
    },
    {
      date: daysFromNow(-280),
      liters: 28.5,
      pricePerLiter: 1.63,
      mileage: 5450,
      station: "Cepsa Arturo Soria",
    },
    {
      date: daysFromNow(-258),
      liters: 35.2,
      pricePerLiter: 1.57,
      mileage: 5700,
      station: "Shell Castellana",
    },
    {
      date: daysFromNow(-240),
      liters: 30.0,
      pricePerLiter: 1.75,
      mileage: 5950,
      station: "BP Chamartín",
    },
    {
      date: daysFromNow(-218),
      liters: 33.8,
      pricePerLiter: 1.68,
      mileage: 6200,
      station: "Repsol Centro",
  ...
  const reminderData = [
    ...
    {
      vehicleId: familySuv.id,
      date: daysFromNow(3),
      description: "Oil change - urgent (red: due in 3 days)",
      type: "maintenance",
      mileage: 30000,
      enabled: true,
    },
    // ORANGE by km: 2000 km left (1000-3000 km away), date far away
    {
      vehicleId: familySuv.id,
      date: daysFromNow(60),
      description: "Tire rotation (orange: 2000 km away)",
      type: "maintenance",
      mileage: 22750,
      enabled: true,
    },
    // RED overdue: due 5 days ago
    {
      vehicleId: familySuv.id,
      date: daysFromNow(-5),
      description: "Brake fluid check - overdue (red: 5 days ago)",
      type: "maintenance",
      mileage: 30000,
      enabled: true,
    },
    ...
    {
      vehicleId: cityCommuter.id,
      date: daysFromNow(45),
      description: "Annual registration renewal (green: 45 days away)",
      type: "registration",
      mileage: 15000,
      enabled: true,
    },
    // ORANGE by date: due in 15 days (7-30 days)
    {
      vehicleId: cityCommuter.id,
      date: daysFromNow(15),
      description: "Brake pads inspection (orange: 15 days away)",
      type: "inspection",
      mileage: 15000,
      enabled: true,
    },
    ...
    {
      vehicleId: weekendRoadster.id,
      date: daysFromNow(60),
      description: "Tire inspection - urgent (red: 500 km away)",
      type: "inspection",
      mileage: 12300,
      enabled: true,
    },
    // GREEN by date and km: 45 days away and 5000 km away
    {
      vehicleId: weekendRoadster.id,
      date: daysFromNow(45),
      description: "Insurance renewal (green: 45 days and 5000 km away)",
      type: "insurance",
      mileage: 16800,
      enabled: true,
    },
  ...
  const maintenanceData = [
    // --- Family SUV (3 maintenances) ---
    {
      ...
      date: "2025-09-15",
      type: "Oil",
      description: "Full synthetic oil change at 10000 km",
      mileage: 10000,
      cost: 89.5,
    },
    {
      ...
      date: "2025-11-20",
      type: "ITV",
      description: "Annual ITV inspection passed",
      mileage: 11200,
      cost: 45.0,
    },
    {
      ...
      date: "2026-01-10",
      type: "Wheels",
      description: "Winter tyre rotation and balancing",
      mileage: 12200,
      cost: 60.0,
    },
    ...
    // --- City Commuter (4 maintenances) ---
    {
      ...
      date: "2025-08-05",
      type: "Oil",
      description: "First oil change at 3000 km",
      mileage: 3000,
      cost: 75.0,
    },
    {
    ...
    },
    {
      ...
      date: "2025-12-01",
      type: "Lights",
      description: "Left headlight bulb replacement",
      mileage: 5000,
      cost: 25.0,
    },
    {
      ...
      date: "2026-02-08",
      type: "ITV",
      description: "Annual ITV inspection passed with notes",
      mileage: 6600,
      cost: 45.0,
    },
    ...
    },
    {
      ...
      date: "2025-08-22",
      type: "Wheels",
      description: "New summer tyres installed (4 units)",
      mileage: 7800,
      cost: 420.0,
    },
    {
      ...
      date: "2025-10-05",
      type: "Brakes",
      description: "Rear brake discs and pads replacement",
      mileage: 8300,
      cost: 310.0,
    },
    {
      ...
      date: "2025-12-18",
      type: "AdBlue",
      description: "AdBlue tank refill (10L)",
      mileage: 9500,
      cost: 15.0,
    },
    {
      ...
      date: "2026-02-14",
      type: "Repair",
      description: "Exhaust pipe bracket weld repair",
      mileage: 10800,
      cost: 135.0,
    },
  ];
  ...
  console.log(
    `Seed completed: ${vehicleCount} vehicles, ${refuelingCount} refuelings, ${reminderCount} reminders, ${maintenanceCount} maintenances created.`,
  );
}
